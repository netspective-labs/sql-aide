...
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTESXRZK29860N3198T3', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'REACTJS'), 'INTERMEDIATE', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTESHYGKE9N05C0PGJ7R', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'JAVASCRIPT'), 'ADVANCED', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTES9Z70SN6MCVW916MH', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'HUGO'), 'FUNDAMENTAL_AWARENESS', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTESR8QXD82MX33N9SCY', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'DENO'), 'INTERMEDIATE', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTESTKKJ7YJXX7TQ1P9G', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'ANGULAR'), 'INTERMEDIATE', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTESTYZDHZNE2BYB0CAY', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'TYPESCRIPT'), 'INTERMEDIATE', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTETHVD5KJ4BFFMD6S3M', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'POSTGRESQL'), 'INTERMEDIATE', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTETRBDVJCX1F6732BN1', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'MYSQL'), 'INTERMEDIATE', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTETYKKQD2GNBDT11H05', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'PHP'), 'INTERMEDIATE', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTET6ZMXATYJSYQ8QMPS', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'PYTHON'), 'FUNDAMENTAL_AWARENESS', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTET0W46EE05W64BEPP7', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'DOT_NET'), 'NA', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTET8WM05HPJRMYNVB2G', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'ORACLE'), 'NA', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTET74Y0CBBNV128QQ3Y', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'JAVA'), 'FUNDAMENTAL_AWARENESS', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTETDSVJTYG5YN4MAESD', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'JQUERY'), 'ADVANCED', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "person_skill" ("person_skill_id", "person_id", "skill_nature_id", "skill_id", "proficiency_scale_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTETG05Q8V7BY7EM006T', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "skill_nature_id" FROM "skill_nature" WHERE "code" = 'SOFTWARE'), (SELECT "skill_id" FROM "skill" WHERE "code" = 'OSQUERY'), 'FUNDAMENTAL_AWARENESS', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "awareness_training" ("awareness_training_id", "training_subject_id", "person_id", "organization_id", "training_status_id", "attended_date", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTET239TRQRYM3JMSD14', (SELECT "training_subject_id" FROM "training_subject" WHERE "code" = 'HIPAA'), (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "organization_id" FROM "organization" WHERE "name" = 'Orgnization Name' AND "license" = 'XXXX-XXXXX-XXXX'), (SELECT "status_value_id" FROM "status_value" WHERE "code" = 'YES'), '2022-02-21', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "security_incident_response_team" ("security_incident_response_team_id", "training_subject_id", "person_id", "organization_id", "training_status_id", "attended_date", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTETFH2CRQDA940V2NXJ', NULL, (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "organization_id" FROM "organization" WHERE "name" = 'Orgnization Name' AND "license" = 'XXXX-XXXXX-XXXX'), NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "rating" ("rating_id", "author_id", "rating_given_to_id", "rating_value_id", "best_rating_id", "rating_explanation", "review_aspect", "worst_rating_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTETF7G6Y3T1NK2XDD8X', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "organization_id" FROM "organization" WHERE "name" = 'Orgnization Name' AND "license" = 'XXXX-XXXXX-XXXX'), (SELECT "rating_value_id" FROM "rating_value" WHERE "code" = 'FOUR'), (SELECT "rating_value_id" FROM "rating_value" WHERE "code" = 'FIVE'), 'Good Service', 'Satisfied', (SELECT "rating_value_id" FROM "rating_value" WHERE "code" = 'THREE'), NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "contract" ("contract_id", "contract_from_id", "contract_to_id", "contract_status_id", "document_reference", "payment_type_id", "periodicity_id", "start_date", "end_date", "contract_type_id", "date_of_last_review", "date_of_next_review", "date_of_contract_review", "date_of_contract_approval", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTET9QPSHC39AGRYRDHZ', (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name'), (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'ORGANIZATION' AND "party_name" = 'Orgnization Name'), (SELECT "contract_status_id" FROM "contract_status" WHERE "code" = 'FINISHED'), 'google.com', (SELECT "payment_type_id" FROM "payment_type" WHERE "code" = 'RENTS'), (SELECT "periodicity_id" FROM "periodicity" WHERE "code" = 'WEEKLY'), '2021-04-20T00:00:00.000Z', '2021-04-20T00:00:00.000Z', (SELECT "contract_type_id" FROM "contract_type" WHERE "code" = 'GENERAL_CONTRACT_FOR_SERVICES'), '2021-04-20T00:00:00.000Z', '2021-04-20T00:00:00.000Z', '2021-04-20T00:00:00.000Z', '2021-04-20T00:00:00.000Z', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "risk_register" ("risk_register_id", "description", "risk_subject_id", "risk_type_id", "impact_to_the_organization", "rating_likelihood_id", "rating_impact_id", "rating_overall_risk_id", "controls_in_place", "control_effectivenes", "over_all_residual_risk_rating_id", "mitigation_further_actions", "control_monitor_mitigation_actions_tracking_strategy", "control_monitor_action_due_date", "control_monitor_risk_owner_id", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTET1P43QCT3MR7ZQ26F', 'Risk description', (SELECT "risk_subject_id" FROM "risk_subject" WHERE "code" = 'TECHNICAL_RISK'), (SELECT "risk_type_id" FROM "risk_type" WHERE "code" = 'QUALITY'), 'Impact to the organization', (SELECT "rating_value_id" FROM "rating_value" WHERE "code" = 'THREE'), (SELECT "rating_value_id" FROM "rating_value" WHERE "code" = 'THREE'), (SELECT "rating_value_id" FROM "rating_value" WHERE "code" = 'THREE'), 'Try forgot password', 1, NULL, 'Mitigation further actions', 'Control monitor mitigation actions tracking strategy', '2022-06-13', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "asset" ("asset_id", "organization_id", "asset_retired_date", "asset_status_id", "asset_tag", "name", "description", "asset_type_id", "asset_workload_category", "assignment_id", "barcode_or_rfid_tag", "installed_date", "planned_retirement_date", "purchase_delivery_date", "purchase_order_date", "purchase_request_date", "serial_number", "tco_amount", "tco_currency", "criticality", "asymmetric_keys_encryption_enabled", "cryptographic_key_encryption_enabled", "symmetric_keys_encryption_enabled", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTEV59QY89R63NE9CFKE', (SELECT "organization_id" FROM "organization" WHERE "name" = 'Orgnization Name' AND "license" = 'XXXX-XXXXX-XXXX'), NULL, (SELECT "asset_status_id" FROM "asset_status" WHERE "code" = 'IN_USE'), '', 'Asset Name', 'Service used for asset etc', (SELECT "asset_type_id" FROM "asset_type" WHERE "code" = 'VIRTUAL_MACHINE'), '', (SELECT "assignment_id" FROM "assignment" WHERE "code" = 'IN_USE'), '', '2021-04-20', NULL, '2021-04-20', '2021-04-20', '2021-04-20', '', '100', 'dollar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "incident" ("incident_id", "title", "incident_date", "time_and_time_zone", "asset_id", "category_id", "sub_category_id", "severity_id", "priority_id", "internal_or_external_id", "location", "it_service_impacted", "impacted_modules", "impacted_dept", "reported_by_id", "reported_to_id", "brief_description", "detailed_description", "assigned_to_id", "assigned_date", "investigation_details", "containment_details", "eradication_details", "business_impact", "lessons_learned", "status_id", "closed_date", "reopened_time", "feedback_from_business", "reported_to_regulatory", "report_date", "report_time", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTEVB3PF7M2MQN9Q3Q21', 'Server Down - Due to CPU utilization reached 100%', '2021-04-20', '2021-04-20T00:00:00.000Z', (SELECT "asset_id" FROM "asset" WHERE "name" = 'Asset Name' AND "description" = 'Service used for asset etc' AND "asset_type_id" = (SELECT "asset_type_id" FROM "asset_type" WHERE "code" = 'VIRTUAL_MACHINE')), (SELECT "incident_category_id" FROM "incident_category" WHERE "code" = 'PERFORMANCE'), (SELECT "incident_sub_category_id" FROM "incident_sub_category" WHERE "code" = 'HARDWARE_FAILURE'), 'MAJOR', 'HIGH', (SELECT "incident_type_id" FROM "incident_type" WHERE "code" = 'COMPLAINT'), 'USA', 'Application down', '', 'All', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), 'Server will down due to CPU utilization', 'We got an alert message of server due to CPU utilization reaching 100% on 02-07-2022 07:30 GTM', (SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'First Name Last Name') AND "person_type_id" = (SELECT "person_type_id" FROM "person_type" WHERE "code" = 'INDIVIDUAL') AND "person_first_name" = 'First Name' AND "person_last_name" = 'Last Name'), '2021-04-20', 'Server was facing issue using due to insufficient harware specfication which cause high CPU utilization, resulting in Crashing of the application', 'Migrated few services to another server in that network range and Restarted server', 'Migrated few services to another server in that network range', 'Application was completely down', 'We need to evlaute the hardware specification and remaining CPU/Memory resources before deploying new applications', (SELECT "incident_status_id" FROM "incident_status" WHERE "code" = 'CLOSED'), NULL, NULL, '', '', '2021-04-20', '2021-04-20T00:00:00.000Z', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "incident_root_cause" ("incident_root_cause_id", "incident_id", "source", "description", "probability_id", "testing_analysis", "solution", "likelihood_of_risk_id", "modification_of_the_reported_issue", "testing_for_modified_issue", "test_results", "created_by", "updated_at", "updated_by", "deleted_at", "deleted_by", "activity_log") VALUES ('01HH3MPTEV5MKFR25V7PJKBXBH', (SELECT "incident_id" FROM "incident" WHERE "title" = 'Server Down - Due to CPU utilization reached 100%' AND "sub_category_id" = (SELECT "incident_sub_category_id" FROM "incident_sub_category" WHERE "code" = 'HARDWARE_FAILURE') AND "severity_id" = 'MAJOR' AND "priority_id" = 'HIGH' AND "internal_or_external_id" = (SELECT "incident_type_id" FROM "incident_type" WHERE "code" = 'COMPLAINT') AND "location" = 'USA'), 'Server', 'Sample description', 'HIGH', 'Sample testing analysis', 'Server restarted', 'HIGH', 'No modifications', 'Sample test case', 'Sample test result', NULL, NULL, NULL, NULL, NULL, NULL);
