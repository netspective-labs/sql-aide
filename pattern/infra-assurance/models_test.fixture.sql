...
INSERT INTO "organization" ("party_id", "name", "license", "registration_date", "created_by") VALUES ((SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'person'), 'Test Name', 'Test License', 'Mon Feb 06 2023 00:00:00 GMT-0500 (Eastern Standard Time)', NULL);

INSERT INTO "organization_role" ("person_id", "organization_id", "organization_role_type_id", "created_by") VALUES ((SELECT "person_id" FROM "person" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'person') AND "person_type_id" = 'PROFESSIONAL' AND "person_first_name" = 'Test First Name' AND "person_last_name" = 'Test Last Name'), (SELECT "organization_id" FROM "organization" WHERE "party_id" = (SELECT "party_id" FROM "party" WHERE "party_type_id" = 'PERSON' AND "party_name" = 'person') AND "name" = 'Test Name' AND "license" = 'Test License' AND "registration_date" = 'Mon Feb 06 2023 00:00:00 GMT-0500 (Eastern Standard Time)'), 'ASSOCIATE_MANAGER_TECHNOLOGY', NULL);
